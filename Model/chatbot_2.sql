...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2025 a las 23:59:43
...
CREATE TABLE `conversaciones` (
  `id` int(11) NOT NULL,
  `pregunta_usuario` varchar(500) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `respuesta_bot` varchar(500) CHARACTER SET utf16 COLLATE utf16_spanish_ci NOT NULL,
